    ...
    <div className="pl-2 flex flex-col  w-full ">
      ...
      <div className="flex flex-col gap-y-1">
        {Array.from({length:5}).map((_, index)=>(
            <VideoCard isHorizontal={true} key={index} author={{name: "Mr Beast", profileImage:profileImage}} createdAt="4 days ago" duration="13:40" id={index} thumbnail={profileImage} title="Making people fight for money" views="125k" />
        ))}
